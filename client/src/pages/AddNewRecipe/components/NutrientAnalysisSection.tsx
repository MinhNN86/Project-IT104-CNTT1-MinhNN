...
import PieNutritionChart from "../../RecipeDetail/components/PieNutritionChart";

export default function NutrientAnalysisSection() {
  ...
  return (
    <>
          ...
          <div className="globalItem" id="proteinCircle">
            <div
              className={`circle green ${
                totalNutrientRecipes.macronutrients.protein === 0 ? "empty" : ""
              }`}
            >
              <div className="circleValue">
      ...
      <div className="micronutrient recipeDetailCard" id="macronutrientsValue">
        <div className="recipeDetailsTitle">
